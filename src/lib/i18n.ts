...
const DICTS: Record<UiLanguage, Dict> = {
  ...
  Bangla: {
    ...
    tracker: "দৈনিক রোগী ট্র্যাকার",
    assistant: "AI সহায়ক",
    hospitals: "কাছাকাছি হাসপাতাল",
    medicines: "ওষুধের মজুত",
    carePlans: "সক্রিয় কেয়ার প্ল্যান",
  ...
  Arabic: {
    ...
    tracker: "المتابعة اليومية للمريض",
    assistant: "المساعد الذكي",
    hospitals: "المستشفيات القريبة",
    carePlans: "خطط الرعاية النشطة",
    trends: "اتجاهات الصحة",
    analytics: "التحليلات",
