...
export const Route = createFileRoute("/tracker")({
  head: () => ({
    meta: [
      { title: "Patient Daily Tracker | AI Virtual Clinic" },
      {
        name: "description",
        content:
          "Log daily vitals and symptom severity for patients under a doctor-guided home-monitoring plan, with automatic escalation checks.",
      },
      { property: "og:title", content: "Patient Daily Tracker | AI Virtual Clinic" },
      { property: "og:description", content: "Daily home-monitoring logs with deterministic escalation alerts." },
      ...
      <div className="mx-auto max-w-5xl space-y-6 pb-8">
        <header>
          <h1 className="flex items-center gap-2 text-2xl font-semibold tracking-tight">
            <HeartPulse className="size-6 text-primary" aria-hidden /> Patient daily tracker
          </h1>
          <p className="mt-1 text-sm text-muted-foreground">
            Home-monitoring logs for patients under an active doctor care plan. Readings are checked by deterministic
